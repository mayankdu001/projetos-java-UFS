...
public class Cadastro extends JFrame {
	...
	public void webcam(String nome) throws IOException {
		...
		if (webcam != null) {
			...
			JOptionPane.showMessageDialog(null,
					"Vamos Capturar Sua Foto Fixe Sua Face Para a Webcam!!!"
							+ "\n Para Continuar o Cadastro" + "\nClick OK");

			webcam.setViewSize(d);
			webcam.open();
			ImageIO.write(webcam.getImage(), "PNG", new File("src/img/"+nome + ".png"));
			webcam.close();
	...
	public Cadastro() {
		...
		JOptionPane.showMessageDialog(null, "A Aplicação"
				...
				+ "\n Por Favor Antes de Clicar no Botão Iniciar"
				+ "\n Incira os Nomes dos 2 Jogadores." + "\n Para Continuar"
				+ "\n Clik 'OK' ");
