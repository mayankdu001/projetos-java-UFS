...
class Pessoa {
	...
	Pessoa(String p_nome, int p_idade, char p_sexo) {
		/*
		 * p_nome p_idade p_sexo parametros onde q vai receber o valor da classe
...
class Gerente extends Funcionario {
	String setor;// VARIALE EXCLUSIVA DA CLASS GERENTE
					// variavel da classe gerente onde não tem nada em comum com
					// a
	...
	public Gerente(String g_nome, int g_idade, char g_sexo, String g_cargo,
		 ...
		 * String g_setor
		 * 
		 * String g_nome int g_idade char g_sexo String g_cargo 
		 * #double g_salario #String g_setor { não vai pra a classe funcionario pois ele
		 * ja esta salvando o valor do parametro na variavel setor q é exlusiva
		 * da classe gerente} parametros da classe gerente e da classe onde ele
		 * esta erdando
		 */
